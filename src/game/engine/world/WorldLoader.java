...
public class WorldLoader {
	...
	public static World loadWorldComplete(GameClass g, String name) {
		World world = loadWorld(g,Gdx.files.internal("resources/"+name));
		loadWorldFore(g,Gdx.files.internal("resources/"+name),world);
		loadWorldBack(g,Gdx.files.internal("resources/"+name),world);
		return world;
	}
